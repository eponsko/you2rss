...
import datetime
django.setup()
from you2rss.models import Channel,Video
...
def update_videos(channel):
    ...
    while more:
        ...
        insert_videos(channel,videos,latest)

def insert_videos(channel,videos,latest):
